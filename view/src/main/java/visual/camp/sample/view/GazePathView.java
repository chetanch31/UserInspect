...
public class GazePathView extends View {
  ...
  private static final float MAX_POINT_RADIUS = 120;
  private static final float getCurPointSize=MIN_POINT_RADIUS;
  private static final long MAX_FIXATION_SIZE_TIME = 4000;
  private static final float SACCADE_LINE_WIDTH = 4.F;
