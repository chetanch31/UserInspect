...
public class GazeTrackerManager {
  ...
  final DatabaseReference dbRef = FirebaseDatabase.getInstance().getReference("seeso");
  dbRef.addValueEventListener(new ValueEventListener() {
    @Override
    public void onDataChange(DataSnapshot dataSnapshot) {
      // This method will be called whenever the value of the key changes
      String SEESO_LICENSE_KEY = dataSnapshot.getValue(String.class);
